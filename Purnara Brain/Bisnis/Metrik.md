...
Setiap event membawa `project_id` dan `mode`. Event yang melibatkan AI juga membawa versi prompt. Karena Purnara dua bahasa, tambahkan juga properti `locale`, supaya metrik bisa dibandingkan antara pengguna ID dan EN.
