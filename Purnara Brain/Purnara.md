...
**Purnara** berasal dari kata *purna*: lengkap, tuntas. Yang dijual adalah hasil akhirnya: project besar benar-benar selesai tepat waktu. Nama ini dipilih pada 2026-09-24 menggantikan nama kerja Rampung ([[K-004 Nama produk Purnara]]). Purnara adalah workspace project berbasis AI. AI memegang konteks utuh sebuah project, lalu membantu merencanakan, memantau, dan menyusun ulang rencana saat keadaan berubah. Pasar pertama: mahasiswa tingkat akhir di Indonesia yang mengerjakan skripsi, TA, dan penelitian.
...
| Validasi (Fase 0) | [[Hipotesis]] · [[Panduan Wawancara Mahasiswa]] · [[Panduan Wawancara Dosen]] · [[Cek Nama]] · [[Nama Cadangan]] · `Validasi/Hasil Wawancara.base` |
