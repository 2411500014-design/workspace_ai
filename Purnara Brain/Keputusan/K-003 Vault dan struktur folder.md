...
## Belum diputuskan
- **Mengganti nama package** `workspace_ai` menjadi `purnara`, termasuk application ID Android (`com.example.workspace_ai`) dan bundle ID iOS. Nama Purnara sudah dipilih ([[K-004 Nama produk Purnara]]). Penggantian dilakukan saat Fase 1 dimulai, karena aplikasi belum dibangun selama Fase 0.
