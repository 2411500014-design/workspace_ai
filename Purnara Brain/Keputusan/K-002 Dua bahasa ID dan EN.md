...
## Keputusan
Aplikasi dan web Purnara bisa dipakai dalam **Bahasa Indonesia dan English**. Pondasinya dipasang sejak Fase 1: setiap teks UI punya key di dua ARB, bahasa pengguna tersimpan di `profiles.locale`, dan AI, email, serta notifikasi mengikuti bahasa itu.
