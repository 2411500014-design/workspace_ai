...
| --- | --- | --- | --- |
| ~~Nama "Rampung" bentrok dengan merek terdaftar "Rampung Indonesia" (kelas 41)~~ **Selesai 2026-09-24: nama diganti ke Purnara** ([[K-004 Nama produk Purnara]]) | — | Konsultasi konsultan KI sebelum ada biaya untuk merek, domain, atau logo; siapkan nama cadangan; pertimbangkan penghapusan karena tidak dipakai, pembelian, atau lisensi ([[Cek Nama]]) | Konsultan menilai ada persamaan pada pokoknya, atau pemilik merek mulai aktif |

| Nama **Purnara** belum didaftarkan sebagai merek dan domainnya belum dibeli. Karena sistemnya *first to file*, pihak lain bisa mendaftar lebih dulu | 3 (3×1) | Daftarkan merek dan beli domain begitu ada dana; cek ulang PDKI dan RDAP sebelum mengumumkan nama secara luas | Muncul permohonan merek "Purnara" di PDKI, atau domainnya terdaftar orang lain |
