...
Setiap preset membawa teks yang tampil ke pengguna: nama template, istilah UI, dan persona AI. Karena Purnara dua bahasa, field seperti ini perlu versi `id` dan `en` di YAML. Contoh bentuknya:
